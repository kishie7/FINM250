...
plt.plot(s1_result['timestamp'], s1_result['portfolio_value'], label='ML Signal', alpha=0.8)
...
plt.plot(s1_result['timestamp'], s1_result['drawdown'], label='ML Signal', alpha=0.8)
